...
public:
    ...
    // Add a new customer
    void addCustomer(int code, const string& name, const string& dob, int balance) {
        Customer* newCustomer = new Customer{code, name, dob, balance, nullptr};
        if (!customerHead) {
    ...
    // Deposit money
    void deposit(int customerCode, int amount) {
        Customer* customer = findCustomer(customerCode);
        if (!customer) {
    ...
    // Withdraw money
    void withdraw(int customerCode, int amount) {
        Customer* customer = findCustomer(customerCode);
        if (!customer) {
            cout << "Customer not found.\n";
            return;
